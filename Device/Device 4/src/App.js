...
function App() {
  ...
  function handleGenerate() {
    ...
    var priv_0x = "0x" + priv;
    var Id = sha3.keccak256(pub + gateway4_pubKey);
  ...
  function handleStart() {
    ...
    let cipher_str = cipher.toString("hex");
    client.publish("gateway4/priv", cipher_str);
    client.on("connect", () => {
      ...
      client.on("message", (topic, rcv) => {
        ...
        if (data.remark === "register") {
          ...
          if (d1.getTime() > d2.getTime()) {
            //2.
            // let pubKeyObj = ec.keyFromPublic(gateway4_pubKey,"hex");
            ...
            //   let enc_data = encrypt(snd, gateway4_pubKey);
            //   client.publish('gateway4/auth', enc_data);
  ...
  function handleRegister() {
    ...
    client.publish("gateway4/register", cipher_str);
  }
  ...
  function handleAuth() {
    ...
    client.publish("gateway4/nonce", cipher_str);
  }
